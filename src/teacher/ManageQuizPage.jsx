...
function ManageQuizPage() {
    ...
    return (
        <div className="md:p-6 bg-gray-50 min-h-screen">
            <h2 className="px-12 py-2.5 md:px-0 md:py-0 text-2xl font-bold mb-6 text-green-600">Manage Quiz</h2>

            <div className="space-y-3 px-3.5 md:px-0">
                {/* Filters */}
                ...
                {/* Table */}
                <div className=" overflow-x-auto bg-white shadow-md rounded-lg md:mt-15">
